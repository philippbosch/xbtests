...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Test.title'
        db.add_column('pagetests_test', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Test.title'
        db.delete_column('pagetests_test', 'title')
